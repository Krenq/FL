	...
	return (
		<>
			<section
				...
				className={`absolute flex z-20 drop right-0 transition-all bg-white -mt-1 ${scrollMenu ? '-mt-6' : ""} ${show.showCatal ? 'active' : 'hiddenCustom'
					}`}
			>
					...
					<section>
						...
						<div className="flex ..5x1:m-2 mt-7 ml-10">
							<div className="mr-24 .3x1:mr-8 ..5x1:mr-6">
								<p className="font-semibold border-b-2 border-primary mb-4 w-36 text-xs cursor-pointer hover:text-black">
									Антивозрастной уход
								</p>
								<p className="text-gray-quick-silver text-xs mb-4 relative cursor-pointer hover:text-black">
									День <small className="absolute -top-0.5 ml-1">20</small>
								</p>
								<p className="text-gray-quick-silver text-xs mb-4 relative cursor-pointer hover:text-black">
									Ночью <small className="absolute -top-0.5 ml-1">11</small>
								</p>
								<p className="text-gray-quick-silver text-xs relative cursor-pointer hover:text-black">
									Экстра уход{' '}
									<small className="absolute -top-0.5 ml-1">18</small>
								</p>
								<p className="font-semibold border-b-2 border-primary mb-4 mt-10 text-xs w-32 cursor-pointer hover:text-black">
									Глубокое очищение
								</p>
								<p className="text-gray-quick-silver mb-4 text-xs relative cursor-pointer hover:text-black">
								...
								<p className="font-semibold border-b-2 border-primary mb-4 mt-10 w-10 text-xs cursor-pointer hover:text-black">
									Маски
								</p>
								<p className="text-gray-quick-silver mb-4 text-xs relative cursor-pointer hover:text-black">
							...
							<div className="mr-20 .3x1:mr-8 ..5x1:mr-2">
								<p className="font-semibold border-b-2 border-primary mb-4 w-48 text-xs cursor-pointer hover:text-black">
								...
								<p className="font-semibold border-b-2 border-primary mb-4 mt-10 w-32 text-xs cursor-pointer hover:text-black">
									Проблемная кожа
								</p>
								<p className="text-gray-quick-silver mb-4 text-xs relative cursor-pointer hover:text-black">
								...
								<p className="font-semibold border-b-2 border-primary mb-4 mt-10 text-xs cursor-pointer hover:text-black">
								...
								<p className="font-semibold border-b-2 border-primary mb-4 mt-10 w-40 text-xs cursor-pointer hover:text-black">
							...
							<div className=".2x1:mr-2 dropdownSL">
								...
								<div className="flex items-center mb-2 imgIS">
									...
									<p className="text-xs ml-1 text-gray-quick-silver tracking-widest text-md">
										BOTOLUXE
									</p>
								</div>
								<div className="flex items-center mb-2 imgIS">
								...
								<p className="font-semibold border-b-2 border-primary mt-4 w-24 text-xs cursor-pointer">
									Все серии (16)
								</p>
							</div>
						</div>
				...
				<div className="p-4 .1x01:p-1 border-l-2 w-22% .2x1:w-20% border-gray">
					<Slider {...settingsTwo} className="dropDownSliderAc mb-10">
						<div className="relative sliderItemCatal">
							...
							<p className="font-medium tracking-widest text-xs absolute top-6 left-5 .2x1:left-1 ">
								АКЦИЯ ВЕСНЫ
							</p>
							<p className="tracking-widest text-xl absolute top-12 left-5 .2x1:left-1 .2x1:text-base">
								Расцветай <br /> вместе с нами
							</p>
							<p className="flex items-center tracking-widest absolute bottom-4 right-6">
								Смотреть{' '}
								<svg
									className="ml-1"
									width="12"
