...
const CatalDropdown = ({ show, setShow, scrollMenu }) => {
	...
	return (
		<>
			<section onMouseLeave={setShow} className={`absolute flex z-20 drop right-0 transition-all bg-white ${scrollMenu ? '-mt-5' : ""} -mt-1 ${show.showCatal ? 'active' : "hiddenCustom"}`}>
