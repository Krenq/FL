...
export default function ProductItem({ title, photo, lastItem }) {
	return (
		<>
			{lastItem ? (
				<>
					<div className="flex flex-col hover:!bg-primary hoverWhiteCat items-center justify-center w-full max-w-228px max-h-228px bg-green-05pe cursor-pointer transition-all .3x1:hidden">
					...
					<div className="hidden max-w-228px w-95 h-full max-h-262px cursor-pointer hover:opacity-90 hover:text-primary transition-all .3x1:flex .3x1:flex-row-reverse .3x1:border .3x1:border-gray-light2 .3x1:m-1 ..6x3:h-16">
