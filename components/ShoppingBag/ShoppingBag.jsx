...
export default function ShoppingBag({ scrollMenu, setIsHover }) {
	return (
		<div className="relative mx-4 cursor-pointer" onMouseLeave={setIsHover}
