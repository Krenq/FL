	...
	return (
		<div className="relative">
			...
			<section className="container__special relative pb-10">
				...
				<button className="text-primary border-2 absolute ..6x5:text-sm left-1/2 ability top-40   z-10 border-primary mb-8 py-4 px-10 transition-all hover:bg-primary hover:text-white ..6x6:text-xs">Бизнес-возможности</button>
				<Slider {...settings} className='pt-64'>
