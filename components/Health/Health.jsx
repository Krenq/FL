...
const Health = () => {
	...
	return (
		<div className="relative">
			<svg className='ability ..6x2:h-36 ..6x2:mt-5 absolute left-1/2 -top-6 ' width="184" height="183" viewBox="0 0 184 183" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<section className="bg-gray-light pb-28 .1x1:pb-10 ..5x1:pb-0">
				<div className="container__special">
					<p className="absolute ability left-1/2  text-black  text-2xl pt-20 font-medium ..6x04:text-xl">Программы</p>
					<p className="text-center text-black pt-28 italic text-3xl font-medium ..6x04:text-2xl">КРАСОТЫ И ЗДОРОВЬЯ</p>
					...
					<Slider {...settings} className='flex  '>
						<div>
							...
							<div className="relative mt-3 mr-3 cursor-pointer transition-all hover:text-primary hover:opacity-90">
								<p className="absolute ..6x04:text-xl z-10 top-20 text-2xl text-primary left-10 ..7x2:left-2">«ЗДОРОВЫЙ СОН»</p>
								<p className="absolute ..6x04:text-2xl z-10 top-32 text-3xl   left-10 ..7x2:text-lg ..7x2:left-2" >Чтобы каждое утро было <br /> добрым</p>
								<Image className="object-cover" src={twoHealth} alt="discountImg" />
								<p className='absolute top-52 cursor-pointer z-10 left-10 flex items-center text-sm ..7x2:left-2'>Подробнее <svg className='ml-2' width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<div>
							<div className="relative ml-3 transition-all hover:text-primary hover:opacity-90 cursor-pointer">
								...
								<p className="absolute ..6x04:text-xl z-10 top-20 text-2xl left-10 ..7x2:left-2">«ЧИСТАЯ КОЖА»</p>
								<p className="absolute ..6x04:text-2xl z-10 top-32 text-3xl text-primary left-10 ..7x2:text-lg ..7x2:left-2">Фитокоррекция <br /> проблемной кожи</p>
								<p className='absolute top-52 cursor-pointer z-10 left-10 flex items-center text-sm  ..7x2:left-2'>Подробнее <svg className='ml-2' width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path d="M8.02523 0.935913L7.08463 1.70374L9.26479 3.46684L0.194763 3.47426L0.196105 4.55759L9.24128 4.5502L7.09785 6.2999L8.04286 7.06414L11.8053 3.99286L8.02523 0.935913Z" fill="black" />
								</svg>
								</p>
