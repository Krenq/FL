...
const SearchWindow = ({
  ...
  const setSearch = () => setIsSearch(!isSearch),
    ...
    setRecomend = () =>
      setNowFilter({ idea: false, gifts: false, recomend: true });
  ...
  return (
    <>
      <div
        ...
        className={`${
          isHoverBasket ? 'active  ' : 'hiddenCustom'
        } absolute top-5 ${
          scrollMenu ? 'top-10 !left-0 !fixed' : ''
        } -left-1816px w-1816px  bg-red h-14 z-30`}
      ></div>
      <section
        onMouseEnter={setIsHover}
        onMouseLeave={setCloseHover}
        className={`absolute ${
          isHoverBasket ? '!flex' : '!hidden'
        } dropDownShadow border border-gray right-91.7% -mr-1.5 top-16 bg-white searchwindow ${
          scrollMenu ? '!top-14 !-mt-3px' : ''
        }`}
      >
        <div className="w-475px .4x2:w-380px">
          <h3 className="text-22px text-center -mb-2 mt-4 font-montserrat">
            Предложения для вас
          </h3>
          <div className="flex justify-between  border-b border-gray   mt-5">
            <p
              onClick={setGifs}
              className={`ml-9 text-13px text-black-70pe px-2 .2x1:ml-2 .2x1:text-10px font-medium transition-all cursor-pointer hover:text-black hover:border-b   pb-1 font-montserrat ${
                nowFilter.gifts ? 'activeSpecialDrop' : ''
              }`}
            >
              Акции и подарки
            </p>
            <p
              onClick={setIdea}
              className={`text-13px text-black-70pe font-medium px-2 .2x1:text-10px transition-all cursor-pointer hover:text-black hover:border-b   pb-1 font-montserrat ${
                nowFilter.idea ? 'activeSpecialDrop' : ''
              }`}
            >
              Идеи подарков
            </p>
            <p
              onClick={setRecomend}
              className={`mr-9 text-13px text-black-70pe px-2 .2x1:mr-2 .2x1:text-10px font-medium transition-all cursor-pointer hover:text-black hover:border-b   pb-1 font-montserrat ${
                nowFilter.recomend ? 'activeSpecialDrop' : ''
              }`}
            >
              Рекомендации
            </p>
          ...
          <div className="flex justify-center foryou pb-5 overflow-auto flex-wrap">
            ...
            <div className="   bg-primary-searchBG flex flex-col px-11 itemSeeAll justify-center items-center  ml-3 mt-4 transition-all hover:bg-primary cardHover overflow-hidden">
              <p className="font-montserrat text-center  font-semibold text-2xl text-primary">
                Идеи <br /> подарков
              </p>

              <p className="flex items-center mt-5  font-montserrat text-13px font-medium text-primary">
                Смотреть все{' '}
                <svg
                ...
                >
                  <path
                    d="M10.0253 3.93604L9.08469 4.70386L11.2648 6.46696L2.19482 6.47438L2.19617 7.55771L11.2413 7.55032L9.09791 9.30003L10.0429 10.0643L13.8053 6.99299L10.0253 3.93604Z"
                    fill="#337202"
                  />
                </svg>
              </p>
          ...
          {isSearch ? (
            <div className="relative">
              ...
              <input
                ...
                className="w-full border-gray border-b py-4 pb-3.5 pl-8 pr-24 outline-none font-noto-sans text-13px"
                type="text"
              ...
              <button
                className={` ${
                  search.length > 0 ? '!bg-primary !text-white' : ''
                } transition-all text-xs py-2 px-5 bg-gray-light absolute top-2 right-2 cursor-pointer rounded text-primary font-medium font-montserrat`}
              >
                Найти
              </button>
            </div>
            ...
            <div className="py-2 px-4 flex justify-between">
              {search.length > 0 ? (
                <>
                  <div className="flex items-center">
                    ...
                    <label
                      ...
                      className="w-4 h-4 border-gray-deNum cursor-pointer border"
                    ></label>
                    <p className="text-13px mx-1 font-noto-sans text-black">
                      Выделить все
                    </p>
                    <p className="text-13px ml-4 font-montserrat text-primary font-medium">
                      Добавить выбранные
                    </p>
                  </div>
                </>
                ...
                <>
                  ...
                  <button className="text-13px text-gray-quick-silver font-montserrat font-medium">
                    Очистить
                  </button>
                </>
              )}
            ...
            {search.length > 0 ? (
              ...
              <>
                <div className="flex items-center bg-input-error-bg justify-between px-4 py-10px">
                  <p className="text-13px font-noto-sans">
                    Недоступны для заказа (2)
                  </p>
                  <button className="text-13px font-montserrat font-medium   text-label-pink-2">
                    Удалить все
                  </button>
                </div>
                <SearchWindowItem
                  ...
                  access={true}
                  isProductToDay={true}
                  text={`ВОССТАНОВЛЯЮЩИЙ ШАМПУНЬ С ЭКСТРАКТОМ ЖЕНЬШЕНЯ`}
                  isNew={true}
                  isHit={true}
                  sale={15}
                  balls={1.2}
                ...
                <SearchWindowItem
                  src={twoT}
                  text={
                    'ПЕКТИНОВЫЙ КИСЕЛЬ С СОКОМ ОБЛЕПИХИ И ЯБЛОКАМИ «БАЛАНС»'
                  }
                  price={'0.00'}
                  oldPriceFr={'89.00'}
                  isPresent={true}
                ...
                <div className="flex items-center justify-between px-4 py-10px">
                  <p className="text-13px font-noto-sans">
                    Товары по программе лояльности (4)
                  </p>
                  <button className="text-13px font-montserrat font-medium text-gray-deNum">
                    Очистить
                  </button>
                </div>
                <SearchWindowItem
        ...
        <div className="productNum .2x1:mx-2  mt-2 mx-4">
          <div className="  flex justify-between items-center w-full">
            ...
            <div className="flex">
              <p className="font-montserrat font-medium text-13px text-gray-quick-silver mr-1">
                5 шт.
              </p>
              <p className="font-montserrat flex items-center font-medium text-13px text-black-70pe">
                <svg
                  className="mr-0.5"
                  width="16"
                  height="16"
                ...
                >
                  <path
                    d="M10.333 14.3333C10.333 14.3333 5.99967 14.6667 3.66634 12C1.33301 9.33333 1.33301 1.33333 1.33301 1.33333C1.33301 1.33333 9.33301 1 11.9997 3C14.6663 5 13.9997 10.6667 13.9997 10.6667"
                    stroke="#337202"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M14.6663 14.6668C14.6663 14.6668 10.9399 11.8507 8.66634 9.3335C6.39277 6.81633 5.33301 4.3335 5.33301 4.3335"
                    stroke="#337202"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M8.66699 9.33333L9.00033 5"
                    stroke="#337202"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
                  <path
                    d="M8.66634 9.33333L5.33301 9"
                    stroke="#337202"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                  />
          ...
          <div className="flex justify-between mt-1">
            <p className="font-montserrat font-normal text-13px text-gray-quick-silver">
              Сумма, ₽
            </p>
          ...
          <div className="flex justify-between mt-2">
            ...
            <p className="font-montserrat font-normal text-13px text-label-pink-2">
              -702.00 ₽
            </p>
          </div>
          <div className="flex justify-between mt-2">
          ...
          <div className="">
            <div className="flex justify-between  mt-2 items-center">
              ...
              <div className="flex items-center">
                <p className="mr-1 text-label-pink-2 text-13px font-montserrat font-medium">
                  4 320.00 ₽
                </p>
                <span className="font-medium font-montserrat text-gray-light2">
                  /
                </span>
                <p className="ml-1 text-label-orange font-montserrat font-medium text-13px">
                  {' '}
                  3 750 De
                </p>
              </div>
            ...
            <div className="bg-gray-light buttonsSearch py-3 .2x1:px-2 .4x2:px-2 .4x2:flex px-4">
              <button className="px-7 w-176px py-2 px-0 .2x10:w-auto h-8 .2x1:px-2 transition-all hover:bg-gray-light2 .2x1:text-9px .4x2:px-3 bg-white text-xs font-montserrat font-medium text-primary border border-primary">
                Перейти в корзину
              </button>
              <button className="px-8 w-176px py-2 h-8 .2x10:w-auto .2x1:px-2 transition-all hover:bg-primary-hover .2x1:text-9px .4x2:px-4  ml-4 text-xs font-montserrat  font-medium text-white bg-primary border border-primary">
                Оформить заказ
              </button>
            </div>
          </div>
          <div
            ...
            className={`transition-all ${
              !dropDownds.sale
                ? '!h-20 !overflow-hidden border-b border-dashed border-gray'
                : ''
            }`}
          >
            <div
              className={`mt-4 bg-white-BG_FILTER .2x1:px-2 p-18px pt-2 pb-3  ${
                !dropDownds.sale ? '!bg-white  ' : ''
              }`}
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <div className="ml-3.5">
                    <p className="font-montserrat font-semibold text-13px">
                      Скидка 35%
                    </p>
                    <p className="font-montserrat text-13px text-label-pink-2 font-normal mt-1">
                      5 080.00 ₽
                    </p>
                  </div>
                </div>
                <div className={`-mr-1.5 ${!dropDownds.sale ? 'prev' : ''}`}>
                  ...
                  >
                    <path
                      d="M10.3396 10.675L7 7.3219L3.65312 10.675L2.625 9.64271L7 5.25L11.375 9.64271L10.3396 10.675Z"
                      fill="black"
                      fillOpacity="0.7"
                    />
                  </svg>
              ...
              <div className="flex justify-between mt-3">
                <p className="font-montserrat text-13px text-black-70pe">
                  Ваш заказ:
                </p>
                <div className="flex ">
                  <p className="flex .2x1:text-10px .4x2:text-11px items-center font-montserrat text-black-70pe text-13px font-medium">
                    <svg
                      className="mr-1 .2x1:h-3 .2x1:w-3"
                      width="16"
                      height="16"
                      viewBox="0 0 16 16"
                      fill="none"
                    ...
                    47.5 Б.{' '}
                    <span className="mx-1 text-black .4x2:text-11px .2x1:text-10px ">
                      /
                    </span>
                  </p>
                  <p className="font-montserrat text-13px text-black .4x2:text-11px .2x1:text-10px .2x1:mt-0.5">
                    9 079.00 ₽
                  </p>
                </div>
              </div>
              <div className="flex justify-between items-center">
                <p className="font-montserrat text-13px text-black-70pe  mt-6px">
                  Расчёт:
                </p>

                <p className="font-montserrat text-13px text-black .4x2:text-11px .2x1:text-9px .2x1:mt-1.5  ">
                  (9 079.00 ₽ - (20 Б. * 64 ₽)) * 35%
                </p>
              </div>
            </div>
            <div className="bg-input-error-bg pl-4 py-3 px-2">
              <p className=".2x1:text-10px font-montserrat leading-140% text-11px font-normal flex items-center">
                ...
                >
                  <path
                    d="M7.33301 10.0003H8.66634V11.3337H7.33301V10.0003ZM7.99968 2.66699C5.05968 2.66699 2.66634 5.06032 2.66634 8.00032C2.66634 10.9403 5.05968 13.3337 7.99968 13.3337C10.9397 13.3337 13.333 10.9403 13.333 8.00032C13.333 5.06032 10.9397 2.66699 7.99968 2.66699ZM7.99968 14.667C7.1242 14.667 6.25729 14.4946 5.44845 14.1595C4.63962 13.8245 3.90469 13.3334 3.28563 12.7144C2.03539 11.4641 1.33301 9.76843 1.33301 8.00032C1.33301 6.23221 2.03539 4.53652 3.28563 3.28628C3.90469 2.66722 4.63962 2.17616 5.44845 1.84112C6.25729 1.50609 7.1242 1.33366 7.99968 1.33365C9.76779 1.33366 11.4635 2.03603 12.7137 3.28628C13.964 4.53652 14.6663 6.23221 14.6663 8.00032C14.6663 8.8758 14.4939 9.74271 14.1589 10.5515C13.8238 11.3604 13.3328 12.0953 12.7137 12.7144C12.0947 13.3334 11.3597 13.8245 10.5509 14.1595C9.74206 14.4946 8.87516 14.667 7.99968 14.667ZM7.33301 4.66699H8.66634V8.66699H7.33301V4.66699Z"
                    fill="black"
                  />
                </svg>
                Второй и последующий заказы - 35% на всю сумму заказа!
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            >
              <div
                className={` bg-white-BG_FILTER .2x1:px-2 p-18px pt-2 pb-3  ${
                  !dropDownds.free ? '!bg-white  ' : ''
                }`}
              >
                <div className="flex items-center mt-3  relative pb-2  ">
                  <svg
                    className={`absolute .2x1:right-0  -right-1.5 top-3 ${
                      !dropDownds.free ? 'prev' : ''
                    }`}
                    width="14"
                    height="14"
                    viewBox="0 0 14 14"
                  ...
                  <div>
                    ...
                    <div className="flex items-center">
                      <div className="flex items-center">
                        <p className="font-montserrat .2x1:mr-0.5 .2x1:text-9px text-11px font-normal mr-1">
                          Курьер
                        </p>
                        <span className="rounded-xl .2x1:mr-0.5 font-montserrat .2x1:text-7px text-10px mr-2 p-1 bg-primary-searchBG text-black-70pe">
                          от 2 500 ₽
                        </span>
                      </div>
                      <div className="flex items-center">
                        <p className="font-montserrat text-11px .2x1:mr-0.5 .2x1:text-9px font-normal mr-1">
                          ПВЗ
                        </p>
                        <span className="rounded-xl font-montserrat .2x1:mr-0.5 .2x1:text-7px text-10px p-1 mr-2  bg-primary-searchBG text-black-70pe">
                          от 1 500 ₽
                        </span>
                      </div>

                      <button className="p-1 rounded-xl bg-primary-searchBG .2x1:text-7px text-11px font-montserrat text-black">
                        ещё
                      </button>
                    </div>
                  </div>
            ...
            <div
              onClick={() => setFilter('loal')}
              className={`transition-all ${
                !dropDownds.loal
                  ? '!h-16 !overflow-hidden border-b border-dashed border-gray'
                  : ''
              }`}
            >
              <div
                className={` bg-white-BG_FILTER .2x1:px-2 p-18px pt-2 pb-3  ${
                  !dropDownds.loal ? '!bg-white  ' : ''
                }`}
              >
                <div
                  className={`flex items-center  mt-3 relative pb-2  ${
                    !dropDownds.loal ? 'prev' : ''
                  }`}
                >
                  <svg
                    className="absolute .2x1:right-0 -right-1.5 top-3"
                  ...
                  <div>
                    ...
                    <p className="font-lora text-13px font-medium text-gray-deNum .2x1:text-10px">
                      De
                      <span className=" font-normal font-montserrat">
                        -счёт:
                      </span>{' '}
                      <span className="font-montserrat text-13px font-normal text-label-orange .2x1:text-10px">
                        9 000 De
                      </span>
                    </p>
                  </div>
            ...
            <div
              ...
              className={`transition-all ${
                !dropDownds.promo ? '!h-16 !overflow-hidden  ' : ''
              }`}
            >
              <div
                className={` bg-white-BG_FILTER .2x1:px-2 p-18px pt-0 pb-3 transition-all ${
                  !dropDownds.promo ? '!bg-white  ' : ''
                }`}
              >
                <div className="flex items-center  mt-3 relative pb-2 ">
                  <svg
                    className={`absolute -right-1.5 top-3 ${
                      !dropDownds.promo ? 'prev' : ''
                    } .2x1:right-0`}
                    width="14"
                    height="14"
                    viewBox="0 0 14 14"
                  ...
                  >
                    ...
                    <path
                      ...
                      fill="white"
                      mask="url(#path-1-inside-1_3631_916831)"
                    />
                  </svg>
                  <div>
                    <p className="font-montserrat text-13px font-semibold">
