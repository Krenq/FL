...
const Trands = () => {
	return (
		<section className="relative bg-gray-light pb-80   .2x1:pb-460px">
			...
			<div className="flex justify-center mt-5">
				<button className="mr-4 ..7x1:text-sm ..7x1:py-2 border-2 py-3 px-6 text-white bg-primary border-primary transition-all hover:bg-white hover:text-primary ..7x1:text-10px">Показать еще</button>
				<button className=" ..7x1:text-sm ..7x1:py-2 border-2 py-3 px-6 text-primary bg-white border-primary transition-all hover:bg-primary hover:text-white ..7x1:text-10px">Посмотреть все</button>
			</div>
		</section>
	)
}
