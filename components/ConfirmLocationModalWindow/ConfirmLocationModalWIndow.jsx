...
const ConfirmLocationModalWindow = () => {
	...
	return (
		<section className={`absolute   ..5x2:fixed ..6x6:bottom-16 ..6x6:h-40 ..6x5:bottom-24 ..5x2:bottom-24 ..5x2:h-44 ..5x2:!top-auto ..5x2:left-0 ..5x2:right-0 ..5x2:w-auto ..5x2:flex ..5x2:justify-center confirm p-8 w-96 h-36 bg-white top-10 left-14 z-9 z-40 ${show ? "hiddenCustom" : "block"}`}>
