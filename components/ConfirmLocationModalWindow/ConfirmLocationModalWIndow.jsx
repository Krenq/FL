const ConfirmLocationModalWindow = () => {
	return (
		<section className="fixed confirm p-8 w-96 h-36 bg-white top-60 left-8 z-9 z-10">
			<div className="relative">
				...
				<div className="flex">
					...
					<button className="px-10 bg-primary text-white text-sm py-3 mt-4   border-2 border-primary">
						Да, верно
					</button>
