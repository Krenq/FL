...
const MaterialsTextProdItem = ({ selectedAll, img }) => {
	...
	return (
		<div className={`px-60px .1x1:px-10 border mr-10px mb-10px relative hoverI transition-all border-white hover:bg-white-BG_FILTER hover:border-gray-light2  ${isUse || selectedAll ? '!border-gray-light2' : ""}`}>
			...
			<svg onMouseEnter={hover} onMouseLeave={hover} className={`absolute cursor-pointer hidden hoverShowI left-3 top-11 ${isUse || selectedAll ? '!block' : ""}`} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
