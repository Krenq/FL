    ...
    <div className=" min-h-317px ..6x03:h-317px h-428px flex justify-center  relative mt-2 p-2 border border-white hover:border-gray active_card mx-2">
      <div className="flex flex-col  items-center max-w-252px mx-auto mt-5">
        <div className="absolute flex left-0 top-0 z-20 px-2 pt-2 gap-0.5">
          ...
          <small className=" font-noto-sans font-medium text-xs ..6x03:text-9px border-2 px-3 py-0.5 ..6x03:py-0 ..6x03:px-1 leading-120% border-gray-quick-silver">
            NEW
          </small>
        ...
        <div className=" hidden ..6x03:block">
          <Image className=" object-cover" src={img} width={130} height={130} />
        </div>
        <div className=" absolute bottom-36 flex flex-row justify-between items-end w-full mb-2 px-3 ..6x03:bottom-110px ..6x03:px-1">
          <div className="flex items-center cursor-pointer">
            <p className=" ..6x03:text-11px text-13px font-normal font-montserrat flex items-center leading-140% text-gray-quick-silver">
              <svg
                className=" mr-0.5"
                width="16"
                height="16"
        ...
        <div className=" absolute bottom-20 px-2 ..6x03:px-0 ..6x03:bottom-70px">
          <p className=" ..6x03:text-10px text-13px font-montserrat font-normal leading-150% text-center text-gray-quick-silver tracking-widest card_text">
        ...
        {/* <div className=" flex flex-row font-montserrat font-normal text-base ..6x03:text-11px mb-2 mt-1">
		<p className="text-center">₽ 764.00</p>
	  </div> */}
