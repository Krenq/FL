...
export default function SectionWithStock() {
  return (
    <article className=" flex flex-row justify-center items-center bg-primary-hover h-42px text-white font-noto-sans text-sm font-medium">
      Кешбэк-марафон
      <div className=" bg-white px-2 text-primary border-2 border-primary font-normal text-lg font-montserrat mx-3">
        17d : 09h : 10m : 20s
      </div>
