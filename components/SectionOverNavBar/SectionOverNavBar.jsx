...
export default function SectionOverNavBar() {
  return (
    <article className=" pt-1 h-8 px-20 border-b border-gray-quick-silver border-opacity-50">
      <div className="max-w-screen-overBar mx-auto flex flex-row justify-between items-center">
        <div className="flex flex-row justify-center items-center">
          <div className="flex justify-center items-center mr-5 text-13px font-normal font-montserrat text-gray-quick-silver">
            ...
            <span className=" ml-2">Москва</span>
          </div>
          <div className="flex justify-center items-center mr-5 text-13px font-normal font-montserrat text-gray-quick-silver">
            <Image src={icons.ICON_PHONE} width={10} height={16} />
            <span className=" ml-2">8-800-700-70-95</span>
          </div>
        ...
        <div className=" text-13px font-normal font-montserrat text-gray-quick-silver ml-10">
          Бесплатная доставка от Р 2.500 +
        </div>

        <div className="flex flex-row items-center">
          <div className="flex items-center text-13px font-normal font-montserrat text-black-70pe border-l border-gray-quick-silver px-2 border-opacity-50">
          ...
          <div className="flex items-center text-13px font-normal font-montserrat text-black-70pe border-x border-gray-quick-silver px-2 border-opacity-50">
            <Image src={icons.ICON_FLAG} width={14} height={15} />
