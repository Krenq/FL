const DiscountSliderItemHover = ({ showProducts, showCentral, title, price, oldPrice, de, subTitle }) => {
	return (
		...
		<section className={`${showProducts ? '!block' : ""} bg-white w-full z-50 fixed bottom-24 left-0 ..6x5:bottom-20 ..6x6:bottom-12 hidden flex-col justify-between text-black   font-montserrat    h-200px p-6 info cursor-default`}>
