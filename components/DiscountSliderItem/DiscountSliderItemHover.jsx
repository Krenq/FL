const DiscountSliderItemHover = ({ showProducts, showCentral, title, price, oldPrice, de, subTitle }) => {
	return (
		...
		<section className={`${showProducts ? '!block' : ""} bg-white w-full z-50 fixed bottom-24 ..6x03:bottom-24 left-0 ..6x5:bottom-24 ..6x6:bottom-16 hidden flex-col justify-between text-black   font-montserrat    h-200px ..6x03:p-6  p-10 pt-5 info cursor-default`}>
