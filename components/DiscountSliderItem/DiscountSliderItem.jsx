    ...
    <>
      <section className="w-full ..5x2:hidden h-800px discSlider">
        <div className="flex h-full ..5x2:flex-col">
          <div className="w-50% h-full ..5x2:bg-trava ..5x2:bg-no-repeat ..5x2:bg-cover relative flex justify-center">
          ...
          <div className="cartinka w-50% h-full ">
            <Image
              className=" object-cover "
              src={img}
              // height={}
      ...
      <section className="w-full hidden ..5x2:block h-800px discSliderPhone">
        <div className="flex h-full flex-col">
          ...
          <div className="cartinka w-full h-50% ">
            <Image
              className="object-cover"
              src={img}
              height={7000}
