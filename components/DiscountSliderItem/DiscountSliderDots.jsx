				...
				<div className="flex h-full ..5x2:flex-col">
					<div className="discountImgWrap w-50%  h-full ..5x2:bg-trava ..5x2:bg-no-repeat ..5x2:bg-cover relative flex justify-center">
						...
						<div className='absolute left-1/2 ability  top-80px w-650'>
							<p className="font-montserrat font-medium text-26px text-center mb-6">{title}</p>
							...
							<div className=" mt-7 w-full flex-wrap absolute   flex">
								<div className="w-52 relative h-52 flex items-center justify-center">
									{one && <div className="bg-white-80pe z-10 rounded-full h-12 w-12 flex items-center justify-center">
										<svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path fill-rule="evenodd" clip-rule="evenodd" d="M5 11C5 11.5523 5.44772 12 6 12C6.55228 12 7 11.5523 7 11V7H11C11.5523 7 12 6.55228 12 6C12 5.44772 11.5523 5 11 5H7V1C7 0.447715 6.55228 0 6 0C5.44772 0 5 0.447715 5 1V5H1C0.447715 5 0 5.44772 0 6C0 6.55228 0.447715 7 1 7H5V11Z" fill="black" />
										</svg>
									...
									{imgOne && <div className="absolute z-0">
										<Image src={imgOne} />
									</div>
									}
								...
								<div className="w-52 relative h-52 flex items-center justify-center">
									...
									{imgTree && <div className="absolute z-0">
										<Image src={imgTree} />
									</div>
									}
								...
								<div className="w-52   h-52 flex items-center justify-center">
									...
									{imgFive && <div className="absolute z-0">
										<Image src={imgFive} />
									</div>
									}
								...
								<div className="w-52 relative h-52 flex items-center justify-center">
									...
									{imgSix && <div className="absolute z-0">
										<Image src={imgSix} />
									</div>
									}
								...
								<div className="w-52 relative h-52 flex items-center justify-center">
									...
									{imgEight && <div className="absolute z-0">
										<Image src={imgEight} />
									</div>
									}
								...
								<div className="w-52 h-52 flex items-center justify-center">
									...
									{imgTen && <div className="absolute z-0">
										<Image src={imgTen} />
									</div>
									}
