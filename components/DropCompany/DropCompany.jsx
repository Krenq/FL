...
const DropCompany = ({ show, setShow }) => {
	return (
		<>
			<section onMouseLeave={setShow} className={`absolute .2x1:pt-2  flex z-20 right-0 left-0 h-56 .3x1:pt-0 .3x1:h-44 .3x1:items-start .3x1:pt-5  transition-all bg-white mt-9 ${show ? 'active' : "hiddenCustom"}`}>
