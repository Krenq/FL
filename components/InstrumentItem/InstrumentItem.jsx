...
export default function InstrumentItem({
  ...
  return (
    <div
      className={` mx-2 py-26px ..5x1:px-1 px-5 mt-7 ..5x1:w-auto w-475px max-w-475px min-w-180px h-250px ..5x1:h-305px flex flex-col items-center justify-between ..5x1:bg-gray-light bg-gray-100 rounded-lg ${
        ...
        {country ? (
          <>
            ...
            <div className="w-full flex justify-between items-center">
              <small className=" ..5x1:hidden max-h-21px flex items-center mr-5 font-medium border-b border-dashed border-gray-quick-silver cursor-pointer">
                {country}{' '}
                <svg
                  className="ml-1"
                  width="10"
