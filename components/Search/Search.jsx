...
export default function Search({ scrollMenu, setIsHover, setShowSearch, setCloseHover, isHoverBasket }) {
	...
	return (
		<article className="relative  ..5x2:mt-1 ..6x03:mt-0 cursor-pointer .5x01:pr-2  pr-86px ..5x2:flex ..5x1:pl-5">
			...
			<div className='..5x2:block hidden  ' onClick={show}>
				<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path fillRule="evenodd" clipRule="evenodd" d="M3.75 11C3.75 6.99594 6.99594 3.75 11 3.75C15.0041 3.75 18.25 6.99594 18.25 11C18.25 15.0041 15.0041 18.25 11 18.25C6.99594 18.25 3.75 15.0041 3.75 11ZM11 2.25C6.16751 2.25 2.25 6.16751 2.25 11C2.25 15.8325 6.16751 19.75 11 19.75C13.1462 19.75 15.112 18.9773 16.6342 17.6949L20.4697 21.5303C20.7626 21.8232 21.2374 21.8232 21.5303 21.5303C21.8232 21.2374 21.8232 20.7626 21.5303 20.4697L17.6949 16.6342C18.9773 15.112 19.75 13.1462 19.75 11C19.75 6.16751 15.8325 2.25 11 2.25Z" fill="#DBDCDA" />
				</svg>
			</div>


			<svg className='hidden ..5x2:ml-4 ..5x2:block ..6x6:h-6 ..6x6:w-6' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
