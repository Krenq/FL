				...
				<div className="flex ..6x4:flex-wrap ..6x4:p-1">
					...
					<div>
						<div className="relative ..6x3:pt-0">
							<p className="..7x2:text-xl ..6x2:text-lg ..6x4:text-2xl ..6x1:top-3 text-4xl z-10 .2x1:text-3xl text-black absolute top-10 left-5 ..5x1:text-2xl">Кешбэк-марафон + <br /> розыгрыш бьюти-гаджетов</p>
							<p className="..7x2:text-base  ..6x2:text-base ..6x4:top-20 ..6x4:text-lg ..6x2:top-16  ..6x1:top-20 text-3xl z-10 .2x1:text-2xl absolute  left-5 top-32 text-primary ..5x1:text-xl ..5x1:top-28">6%, 7%, 8%</p>
