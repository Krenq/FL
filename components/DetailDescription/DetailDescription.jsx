			...
			{showDesc.desc && <div className="mt-8 flex ..5x2:pb-3 ..6x3:mt-0 ..5x2:flex-col pb-32">
				...
				<div className="hidden ..5x2:block">
					<div className=" ">
						...
						<div onClick={(e) => setShowLocal('activeComoonents', e)} className={`mt-1  h-12 buttonShadow py-3.5 p-3 rounded transition-all ${show.activeComponents ? 'activeButtonS !h-300px ..6x5:!h-317px ..6x6:!h-350px ..7x001:!h-387px' : 'overflow-hidden'}`}>
							<div className="flex items-center justify-between">
