...
const SeaAct = () => {
	return (
		<div className='bg-gray-light'>
			<section className="container__special  pt-14 pb-24">
				<p className='text-center font-medium text-2xl'>Каждый сезон</p>
				<p className='text-center font-medium text-3xl italic'>НОВЫЕ АКЦИИ</p>
				...
				<div className='flex'>
					<div className='relative'>
						...
						<p className='absolute bottom-10 cursor-pointer z-10 right-10 flex items-center text-sm'>Смотреть <svg className='ml-2' width="12" height="8" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<div className='flex flex-wrap'>
						<div className="relative bg-white m-2 mt-0 cursor-pointer item">
							...
							<button className='bg-gray text-primary py-3 px-16 mt-2 text-sm'>+ Добавить в заказ</button>
						</div>
						<div className="relative bg-white m-2 mt-0 cursor-pointer item">
							<div className="absolute items-center z-10 flex ">
								<svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
