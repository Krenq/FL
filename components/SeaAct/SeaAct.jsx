      ...
      <section className="container__special relative pt-16 pb-24 ..5x2:pb-20">
        ...
        <div className="flex justify-center ">
          ...
          >
            ...
            {/* <div className="relative p-3 bg-white m-2 mt-0 cursor-pointer item transition-all hover:scale-95 hover:text-primary">
              ...
              <div>
                <p className="absolute left-4 top-48 text-sm flex items-center text-gray-quick-silver">
                  {' '}
                  <svg
                    className="mr-2"
                    width="16"
              ...
              <p className="text-xs text-center  tracking-widest">
                ДЛЯ СЕНСАЦИОННОГО <br /> УВЛАЖНЕНИЯ <br /> И ВОССТАНОВЛЕНИЯ КОЖИ
              </p>
              <div className="flex pl-16 mt-2">
                <p className="text-center text-sm mr-2 text-gray-quick-silver line-through">
                  ₽ 920.00
                </p>
                <p className="text-center text-sm text-label-pink-2">
                  ₽ 764.00
                </p>
              </div>
              <button className=" ..6x04:text-xs text-primary py-3 px-16 mt-10 text-sm hover:text-black transition-all bg-gray-light2">
                + Добавить в заказ
              </button>
            </div>
            <div className="relative p-3 bg-white m-2 mt-0 cursor-pointer item transition-all hover:scale-95 hover:text-primary">
