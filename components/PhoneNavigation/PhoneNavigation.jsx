...
const PhoneNavigation = () => {
  ...
  return (
    <>
      <nav className="hidden border-t border-stroke ..5x2:block bg-white pb-4  ..5x2:fixed ..5x2:bottom-0 ..5x2:w-full z-50">
        <ul className="flex justify-center   ..6x4:justify-around">
          <Link href="/">
          ...
          <li className="relative cursor-pointer">
            <svg
              className="h-12 mb-3.5 mt-5 w-24 ..6x5:h-12 ..6x6:w-14 ..6x6:mt-2.5  ..6x6:mb-3 ..6x6:h-7 ..6x5:w-20"
              width="24"
              height="24"
              viewBox="0 0 24 24"
              fill="none"
          ...
          <Link href="/Menu">
            <li
              className={`relative cursor-pointer ${
                router.pathname === '/Menu' ? 'activeButtonPhone' : ''
              }`}
            ...
            >
              ...
              >
                <path
                  ...
                  fill="white"
                  stroke={`${
                    router.pathname === '/Menu' ? '#337202' : '#949792'
                  }`}
                  strokeWidth="0.6"
                />
              </svg>
