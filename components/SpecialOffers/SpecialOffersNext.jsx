...
const SpecialOffersNext = ({ onClick }) => {
	...
	return (
		<button onMouseEnter={setHoverB} onMouseLeave={setHoverB} className="w-11 h-11 flex items-center justify-center rounded-56px special__next absolute transition-all hover:bg-black bg-white py-2 px-3" onClick={onClick}>
...
export default SpecialOffersNext