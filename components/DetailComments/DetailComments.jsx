			...
			{showDesc.desc && <div className="mt-8 flex ..5x2:pb-3 ..6x3:mt-0 ..5x2:flex-col pb-32">
				...
				<div className="hidden ..5x2:block">
					<div>
						...
						<div onClick={() => setShowLocal('activeComoonents')} className={`mt-1  h-12 buttonShadow p-3.5 rounded transition-all ${show.activeComponents ? 'activeButtonS !h-300px ..6x5:!h-317px ..6x6:!h-350px ..7x001:!h-387px' : 'overflow-hidden'}`}>
							<div className="flex items-center justify-between">
			...
			{showDesc.materials && <div className=" pb-32">
				...
				<div className="flex  ">
					<div className="mr-18px">
						<p className="flex items-center font-montserrat py-3 px-5 transition-all hover:bg-gray-light2 cursor-pointer"><svg className="mr-3" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<p className="flex items-center font-montserrat py-3 px-5 transition-all hover:bg-gray-light2 cursor-pointer">
					...
					<div className="flex flex-wrap ">
						<div className="px-60px border mr-10px mb-10px relative border-gray-light2">
							<div className='flex items-center absolute left-14px top-14px '>
							...
							<svg className="absolute left-3 top-11" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<div className="px-60px  mr-10px mb-10px relative ">
