...
const DetailComments = ({ setShowL, refF }) => {
  ...
  return (
    <section className="px-222px mx-2 ..5x2:px-3  ..5x2:m-0 .2x50:px-36 .6x2:px-24 .6x3:px-10">
      <div
        ref={refF}
        className={`flex w-full ..5x2:hidden ..5x1:h-16 bg-label-bg rounded `}
      >
        <div
          onClick={() => setShowLocalDesc('desc')}
          className={`flex-1 relative ..5x1:h-16 ..5x1:text-base ${
            showDesc.desc ? 'activeCard' : ''
          } cursor-pointer h-86px flex font-montserrat font-medium text-lg justify-center items-center`}
        >
          <svg
          ...
          {showDesc.desc && (
            <div className="absolute left-1/2 ability -bottom-2 h-30px w-30px bg-white rotSearchHover"></div>
          )}
          Описание
        </div>
        <div
          onClick={() => setShowLocalDesc('activeComoonents')}
          className="flex-1   cursor-pointer h-86px relative ..5x1:h-16 flex justify-center items-center"
        >
          <div
            className={`w-full ${
              showDesc.activeComponents ? 'activeCard !h-full' : ''
            }  border-x ..5x1:text-base ..5x1:leading-120%  border-gray  flex font-montserrat font-medium text-lg text-center leading-120% justify-center items-center`}
          >
            <svg
              className="..5x1:h-5 ..5x1:w-5 mr-3"
              width="33"
        ...
        <div
          onClick={() => setShowLocalDesc('materials')}
          className={`flex-1 relative ${
            showDesc.materials ? 'activeCard' : ''
          } cursor-pointer ..5x1:h-16 ..5x1:text-base font-montserrat font-medium text-lg h-86px flex justify-center items-center`}
        >
          <svg
            className="..5x1:h-5 ..5x1:w-5 mr-3"
            width="33"
        ...
        <div className="mt-8 flex ..5x2:pb-3 ..6x3:mt-0 ..5x2:flex-col pb-32">
          <div className="..5x2:hidden">
            ...
            <p className="font-montserrat leading-180 mb-8 ..5x1:mb-4 ..5x1:text-sm ..5x1:leading-120%">
              ...
              Насыщает питательными элементами, удерживает влагу внутри клеток,
              повышая упругость кожи и замедляя процесс образования морщин
            </p>
            ...
            <p className="font-montserrat leading-180 mb-8 ..5x1:mb-4 ..5x1:text-sm ..5x1:leading-120%">
              ...
              области вокруг глаз. Через 10 минут удалите остатки салфеткой или
              мягко вотрите их в кожу. Рекомендуется использовать маску
          ...
          <div className="hidden ..5x2:block">
            <div className=" ">
              <div
                onClick={(e) => setShowLocal('desc', e)}
                className={`mt-1 h-12 buttonShadow p-3 py-3.5 rounded transition-all ${
              ...
              <div
                onClick={(e) => setShowLocal('activeComoonents')}
                className={`mt-1  h-12 buttonShadow py-3.5 p-3 rounded transition-all ${
                  show.activeComponents
                    ? 'activeButtonS !h-300px ..6x5:!h-317px ..6x6:!h-350px ..7x001:!h-387px'
                    : 'overflow-hidden'
                }`}
              >
                <div className="flex items-center justify-between">
                ...
                <Swiper className="mt-2">
                  <SwiperSlide className="p-3 mr-2 ..7x230:p-1 flex bg-gray-light justify-between">
                    <div className="..7x001:mr-2 ..7x230:mr-0 w-65%">
                      <p className="font-montserrat italic font-medium text-13px text-primary mb-1">
                        Мушмула
                      </p>
                      <p className="font-montserrat text-black ..7x230:text-10px italic font-light text-11px leading-180">
                        Экстракт мушмулы германской-источник большого количества
                        витаминов, минералов и органический кислот. Питает кожу,
                        ускоряет обновление клеток, улучшает микрорельеф кожи,
                        разглаживая мелкие морщинки и неровности
                      </p>
                    </div>
                ...
                <p className="mt-6 ..7x230:mt-3 font-montserrat text-11px uppercase tracking-widest">
                  все компоненты этой категории
                </p>
              ...
              <div
                onClick={(e) => setShowLocal('materials', e)}
                className={`mt-1 mb-3  h-12 buttonShadow p-3 py-3.5 rounded transition-all ${
                  show.materials
                    ? `activeButtonS !h-350px ..6x4:!h-428px  ${
                        currentFilterMobile.active
                          ? '!h-1100px ..6x4:!h-1100px ..7x001:!h-1100px'
                          : ''
                      }`
                    : 'overflow-hidden'
                }`}
              >
                ...
                <div className=" overflow-x-auto whitespace-nowrap flex py-2 border-t  border-t-gray-light2">
                  <p
                    onClick={(e) => setFilterItem('photo', e)}
                    className={`flex items-center font-montserrat p-6px rounded-sm transition-all text-11px  hover:bg-gray-light2 cursor-pointer ${
                      currentFilterMobile.photo ? '!bg-gray-light2' : ''
                    }`}
                  >
                    <svg
                      className="mr-3 ..5x2:w-14px ..5x2:mr-1 ..5x2:h-14px"
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                      fill="none"
                  ...
                  <p
                    onClick={(e) => setFilterItem('video', e)}
                    className={`flex items-center p-6px  text-11px rounded-sm font-montserrat   transition-all hover:bg-gray-light2 cursor-pointer ${
                      currentFilterMobile.video ? '!bg-gray-light2' : ''
                    }`}
                  >
                    <svg
                      className="mr-3 ..5x2:w-14px ..5x2:mr-1 ..5x2:h-14px"
                  ...
                  <p
                    onClick={(e) => setFilterItem('service', e)}
                    className={`flex items-center  font-montserrat p-6px  text-11px rounded-sm transition-all hover:bg-gray-light2 cursor-pointer ${
                      currentFilterMobile.service ? '!bg-gray-light2' : ''
                    }`}
                  >
                    <svg
                      className="mr-3 ..5x2:w-14px ..5x2:mr-1 ..5x2:h-14px"
                  ...
                  <p
                    onClick={(e) => setFilterItem('product', e)}
                    className={`flex items-center font-montserrat p-6px  text-11px rounded-sm transition-all hover:bg-gray-light2 cursor-pointer ${
                      currentFilterMobile.product ? '!bg-gray-light2' : ''
                    }`}
                  >
                    <svg
                      className="mr-3 ..5x2:w-14px ..5x2:mr-1 ..5x2:h-14px"
                    ...
                    >
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
                        d="M4 2C4 1.44772 4.44772 1 5 1H19C19.5523 1 20 1.44772 20 2V9H22C22.5523 9 23 9.44772 23 10V19C23 19.5523 22.5523 20 22 20H19.5V22C19.5 22.5523 19.0523 23 18.5 23H5.5C4.94772 23 4.5 22.5523 4.5 22V20H2C1.44772 20 1 19.5523 1 19V10C1 9.44772 1.44772 9 2 9H4V2ZM6 9H18V3H6V9ZM3 11V18H4.49025V16C4.49025 15.4477 4.93797 15 5.49025 15H18.5086C19.0609 15 19.5086 15.4477 19.5086 16V18H21V11H3ZM6.5 17V21H17.5V17H6.5Z"
                        fill="black"
                        fillOpacity="0.7"
                      />
                    </svg>
                  ...
                  <p
                    onClick={(e) => setFilterItem('active', e)}
                    className={`flex  items-center font-montserrat p-6px  text-11px rounded-sm transition-all hover:bg-gray-light2 cursor-pointer ${
                      currentFilterMobile.active ? '!bg-gray-light2' : ''
                    }`}
                  >
                    <svg
                      className="mr-3 ..5x2:w-14px ..5x2:mr-1 ..5x2:h-14px"
                    ...
                    Активность
                    <svg
                      className="ml-3  ..5x2:ml-1 ..5x2:h-5"
                      width="80"
                      height="24"
                      viewBox="0 0 80 24"
                      fill="none"
                    ...
                    >
                      ...
                      />
                      <path
                        d="M44.236 8.29706C44.236 10.6339 42.3338 12.5354 39.9963 12.5354C37.6581 12.5354 35.7565 10.6339 35.7565 8.29706C35.7565 5.95548 37.6588 4.05 39.9963 4.05C42.3337 4.05 44.2353 5.95547 44.236 8.29706ZM43.3364 8.29706C43.3364 6.45156 41.838 4.94963 39.9963 4.94963C38.1539 4.94963 36.6562 6.45157 36.6562 8.29706C36.6562 10.138 38.154 11.6358 39.9963 11.6358C41.8385 11.6358 43.3364 10.138 43.3364 8.29706Z"
                        fill="black"
                        fillOpacity="0.7"
                        stroke="white"
                        stroke-width="0.1"
                ...
                <div className="flex h-34px mb-3  bg-green-files items-center justify-between">
                  <p className="font-montserrat font-medium text-11px text-white ml-4 ..7x01:ml-1 ..7x01:text-10px ">
                    Файлов: 17
                  </p>
                  <div className="flex items-center">
                    <button className="..7x01:text-10px ..7x2:px-2 transition-all text-11px  bg-primary h-26px p-1.5 px-3 rounded-3xl flex items-center font-montserrat font-medium   text-white  ">
                      <svg
                        className=" mr-1 ..5x2:h-14px ..5x2:w-14px"
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                        fill="none"
                ...
                {currentFilterMobile.photo && (
                  <>
                    <div className="flex items-center mb-2">
                      <p className="pb-1 font-montserrat mr-3 font-medium text-13px text-primary border-b border-dashed border-primary">
                        Все
                      </p>
                      <p className="pb-1 font-montserrat font-medium text-13px text-gray-quick-silver border-b border-dashed border-gray-quick-silver">
                        Без подписей
                      </p>
                    </div>
                    <div className="flex mt-3 flex-wrap">
                      <div className="w-150px mr-3 ..7x2:mr-0 ..7x2:w-120px ..7x59:w-130px ..7x59:mr-1 ..7x59:mb-1 mb-3 relative flex justify-end bg-gray-light">
                        <svg
                          className="absolute ..7x59:left-0.5 ..7x2:left-3 ..7x2:top-11 left-3 top-14 z-10"
                          width="24"
                          height="24"
                          viewBox="0 0 24 24"
                          fill="none"
                        ...
                        >
                          <path
                            d="M4 22H20.4706V19.6471H4M20.4706 9.05882H15.7647V2H8.70588V9.05882H4L12.2353 17.2941L20.4706 9.05882Z"
                            fill="#DBDCDA"
                          />
                        </svg>
                        <div className=" flex items-center ..7x59:left-1 ..7x2:left-14px absolute left-14px top-14px ">
                          ...
                          />
                          <label
                            htmlFor="checkSearchAll"
                            className="w-5 h-5 border-gray-quick-silver cursor-pointer border"
                          ></label>
                        </div>
                          ...
                          <div className="absolute left-0 z-10 flex items-center justify-center right-0 top-0 bottom-0">
                            ...
                            >
                              <path
                                fill-rule="evenodd"
                                clip-rule="evenodd"
                                d="M13.8182 10.9613C14.0432 10.8314 14.3205 10.8314 14.5455 10.9613L22.1819 15.3702C22.4069 15.5001 22.5455 15.7402 22.5455 16C22.5455 16.2599 22.4069 16.5 22.1819 16.6299L14.5455 21.0387C14.3205 21.1687 14.0432 21.1687 13.8182 21.0387C13.5932 20.9088 13.4546 20.6687 13.4546 20.4089V11.5912C13.4546 11.3313 13.5932 11.0912 13.8182 10.9613ZM14.9091 12.8508V19.1492L20.3637 16L14.9091 12.8508Z"
                                fill="white"
                              />
                              <path
                                d="M31.5 16C31.5 24.5604 24.5604 31.5 16 31.5C7.43958 31.5 0.5 24.5604 0.5 16C0.5 7.43959 7.43958 0.5 16 0.5C24.5604 0.5 31.5 7.43959 31.5 16Z"
                                stroke="white"
                                stroke-opacity="0.8"
                              />
                            </svg>
                    ...
                    <div className="flex ">
                      <div className="bg-gray-light mr-3 w-150px h-204px p-1">
                        <div className="bg-white h-full w-full flex items-center  flex-col">
                          <p className="font-montserrat font-medium text-13px text-center leading-140% mt-10 mb-0.5">
                            Сертификат соответствия
                          </p>
                          <p className="font-montserrat font-medium leading-120% text-11px text-gray-quick-silver mb-6 text-center">
                          ...
                          <div>
                            ...
                            >
                              ...
                              <path
                                d="M16.7469 9.25C16.7469 8.83579 16.4111 8.5 15.9969 8.5C15.5827 8.5 15.2469 8.83579 15.2469 9.25V17.1862L13.1553 15.0947C12.8624 14.8018 12.3876 14.8018 12.0947 15.0947C11.8018 15.3876 11.8018 15.8624 12.0947 16.1553L15.4274 19.488C15.5649 19.6484 15.769 19.75 15.9969 19.75L15.9984 19.75C16.1909 19.7504 16.3835 19.6772 16.5303 19.5303L19.9053 16.1553C20.1982 15.8624 20.1982 15.3876 19.9053 15.0947C19.6124 14.8018 19.1376 14.8018 18.8447 15.0947L16.7469 17.1925V9.25Z"
                                fill="white"
                              />
                              <path
                                d="M22.75 15.25C23.1642 15.25 23.5 15.5858 23.5 16V22.75C23.5 23.1642 23.1642 23.5 22.75 23.5H9.25C8.83579 23.5 8.5 23.1642 8.5 22.75V16.0031C8.5 15.5889 8.83579 15.2531 9.25 15.2531C9.66421 15.2531 10 15.5889 10 16.0031V22H22V16C22 15.5858 22.3358 15.25 22.75 15.25Z"
                                fill="white"
                              />
                            </svg>
                          </div>
                ...
                {currentFilterMobile.product && (
                  <>
                    <div className="flex items-center mb-2">
                      ...
                      <p className="pb-1 font-montserrat font-medium text-13px text-gray-quick-silver border-b border-dashed border-gray-quick-silver ml-3">
                        Ролл апы
                      </p>
                      <p className="pb-1 font-montserrat font-medium text-13px text-gray-quick-silver border-b border-dashed border-gray-quick-silver ml-3">
                        PDF.
                    ...
                    <div className="flex mt-3 flex-wrap">
                      <div className="w-150px mr-3 ..7x2:mr-0 ..7x2:w-120px ..7x59:w-130px ..7x59:mr-1 ..7x59:mb-1 mb-3 relative flex justify-end bg-gray-light">
                        ...
                        <div className="relative ..7x2:w-20 ..7x2:h-20">
                          <Image src={mobileFilter} />
                          <p className="text-center font-montserrat font-medium text-11px text-gray-quick-silver mb-3">
                            PDF
                          </p>
                        </div>
                      </div>
                    ...
                    <div className=".5x1:w-1100px ..5x2:w-full !ml-0 .4x2:w-910px w-1200 .2x1.0:w-800px .1x01:w-727px ..5x1:w-664px .1x1:ml-4 ..5x01:w-600px">
                      <div className="p-3   border border-stroke">
                        <div className="w-full flex ">
                          <p className="font-montserrat font-medium text-xl ..5x2:text-13px">
                            Статьи
                          </p>
                          <p className="font-montserrat font-medium text-xl text-gray-quick-silver ml-2 ..5x2:text-13px">
                            3
                          </p>
                        </div>
                        <Slider
                          {...settings}
                          className="pt-13px ..5x2:pt-1   newsSlider   "
                        >
                          <div className=" relative pr-5px  ..5x2:!px-0 ..6x04:p-1.5 transition-all  newsCardHover  cursor-pointer hover:scale-95">
                            ...
                            <div className="  -mt-4 relative">
                              ...
                              <p className="text-center titleNews leading-120% font-montserrat ..5x2:hidden px-2 text-lg font-bold">
                                Возвращение легенды: косметический <br /> спонж
                                для умывания
                              </p>
                              <p className="hidden titleNews ..5x2:block font-montserrat ..6x4:text-sm text-center px-3 text-lg font-medium">
                                Возвращение легенды: косметический спонж для
                                умывания
                              </p>
                              <p className="text-center  mt-2 px-5 leading-140% ..6x3:px-4 mb-5 news_text font-montserrat ..6x4:text-11px">
                                Все помнят тот самый косметический спонж,
                                который под струей воды превращался из палочки в
                                круглый диск Все помнят тот самый косметический
                                спонж, который под струей воды превращался
                              </p>
                      ...
                      <div className="p-3 mt-6   border border-stroke">
                        ...
                        <div className="flex ">
                          <div className="mt-3  ..5x2:mt-1 ..5x2:w-272px .5x01:w-300px mr-10px relative">
                            <Image src={i} />
                            <div>
                              <p className="font-montserrat font-semibold text-18px ..5x2:text-13px">
                                Как скрыть следы усталости под глазами
                              </p>
                              <p className="font-montserrat font-medium text-sm ..5x2:text-11px ..5x2:mt-1 text-gray-quick-silver mt-2 mb-4">
                                19 часов назад
                              </p>
                            </div>
                            <div className="absolute top-1.5 flex items-center left-2">
                              ...
                              >
                                <path
                                  fill-rule="evenodd"
                                  clip-rule="evenodd"
                                  d="M5.83317 4.22639C6.09101 4.07753 6.40867 4.07753 6.6665 4.22639L15.4165 9.27823C15.6743 9.42709 15.8332 9.70219 15.8332 9.99991C15.8332 10.2976 15.6743 10.5727 15.4165 10.7216L6.66651 15.7734C6.40867 15.9223 6.09101 15.9223 5.83317 15.7734C5.57534 15.6246 5.4165 15.3495 5.4165 15.0517V4.94808C5.4165 4.65036 5.57534 4.37525 5.83317 4.22639ZM7.08317 6.39146V13.6084L13.3332 9.99991L7.08317 6.39146Z"
                                  fill="white"
                                />
                              </svg>
                            ...
                            >
                              <g clip-path="url(#clip0_3113_149809)">
                                <path
                                  d="M0 15.5C0 8.193 0 4.54 2.27 2.27C4.54 0 8.193 0 15.5 0H16.5C23.807 0 27.46 0 29.73 2.27C32 4.54 32 8.193 32 15.5V16.5C32 23.807 32 27.46 29.73 29.73C27.46 32 23.807 32 16.5 32H15.5C8.193 32 4.54 32 2.27 29.73C0 27.46 0 23.807 0 16.5V15.5Z"
                                  fill="white"
                                  fillOpacity="0.3"
                                />
                                <path
                                  fill-rule="evenodd"
                                  clip-rule="evenodd"
                                  d="M26.398 10.88C26.55 10.373 26.398 10 25.673 10H23.277C22.667 10 22.387 10.322 22.235 10.677C22.235 10.677 21.016 13.646 19.29 15.574C18.732 16.132 18.478 16.31 18.174 16.31C18.021 16.31 17.801 16.132 17.801 15.625V10.88C17.801 10.271 17.624 10 17.116 10H13.351C12.971 10 12.741 10.283 12.741 10.55C12.741 11.128 13.605 11.26 13.694 12.884V16.411C13.694 17.184 13.554 17.324 13.249 17.324C12.437 17.324 10.461 14.343 9.289 10.931C9.06 10.268 8.83 10 8.218 10H5.821C5.137 10 5 10.322 5 10.677C5 11.312 5.812 14.457 8.782 18.618C10.762 21.46 13.552 23 16.09 23C17.612 23 17.8 22.658 17.8 22.069V19.92C17.8 19.236 17.945 19.1 18.427 19.1C18.783 19.1 19.392 19.277 20.813 20.647C22.438 22.272 22.706 23 23.62 23H26.016C26.701 23 27.043 22.658 26.846 21.983C26.63 21.31 25.854 20.333 24.825 19.176C24.266 18.516 23.429 17.806 23.175 17.451C22.82 16.995 22.921 16.791 23.175 16.386C23.175 16.386 26.094 12.276 26.399 10.88H26.398Z"
                                  fill="white"
                                />
                              </g>
                              <defs>
                          ...
                          <div className="mt-3 ..5x2:mt-1 ..6x04:hidden ..5x2:w-272px .5x01:w-300px relative">
                            ...
                            <div className="absolute left-0 right-0 bottom-77px ..5x2:bottom-20 flex .5x01:bottom-100px items-center h-16 justify-end  bg-white-80pe">
                              <button className="flex items-center font-montserrat font-medium text-xs text-white bg-primary hover:bg-primary-hover transition-all h-8 px-5 mr-4 ">
                                ...
                                >
                                  <path
                                    d="M8.75033 4.66683L11.0837 7.00016M11.0837 7.00016L8.75033 9.3335M11.0837 7.00016H2.91699"
                                    stroke="white"
                                    stroke-width="1.5"
                            ...
                            <div>
                              <p className="font-montserrat font-semibold text-18px ..5x2:text-13px">
                                Как правильно подготовить очищать кожу
                              </p>
                              <p className="font-montserrat font-medium text-sm ..5x2:text-11px ..5x2:mt-1 text-gray-quick-silver mt-2 mb-4">
                                2 дня назад
                              </p>
      ...
      {showDesc.activeComponents && (
        <div className="mt-8 ..6x3:hidden pb-32">
          <div className="flex .2x1:flex-col">
            <div className="w-85 .2x1:!w-full">
              <p className="font-montserrat font-medium text-xl mb-6">
                Компоненты в составе маски
              </p>
              <p className="font-montserrat italic font-medium text-primary mb-2">
                Водоросли
              </p>
              <div className="flex mb-10px pb-3 border-b border-gray-light23">
                <p className="font-montserrat w-91 mr-6 font-light text-sm italic leading-180">
                  Экстракт водорослей содержит большое количество питательных
                  веществ, способствует эффективному увлажнению кожи, улучшает
                  тонус и эластичность, смягчает
                </p>
              ...
              <div className="flex mb-10px pb-3 border-b relative border-gray-light23">
                <p className="font-montserrat mr-110px mb-4 font-light text-sm italic leading-180">
                  Экстракт мушмулы германской-источник большого количества
                  витаминов, минералов и органический кислот. Питает кожу,
                  ускоряет обновление клеток, улучшает микрорельеф кожи,
                  разглаживая мелкие морщинки и неровности{' '}
            ...
            <div className="ml-10 .2x1:ml-0 .2x1:mt-4  p-30px bg-gray-100">
              <p className="font-montserrat leading-140% mb-6">
                Все компоненты подбираются по принципу синергии: в сочетании их
                действие усиливается.
              </p>
              <p className="font-montserrat text-11px uppercase mb-1">
                все компоненты этой категории
              </p>
      ...
      {showDesc.materials && (
        <div className=" pb-32">
          <div className="flex h-52px mb-5 bg-green-files items-center">
            <p className="font-montserrat font-medium text-xl text-white ml-4  mr-48">
              Файлов: 17
            </p>
            <div className="flex items-center">
          ...
          <div className="flex  ">
            <div className="mr-18px .1x1:mr-0">
              <p
                onClick={() => setFilterItem('photo')}
                className={`flex items-center font-montserrat py-3 px-5 transition-all hover:bg-gray-light2 cursor-pointer ${
                  currentFilter.photo ? '!bg-gray-light2' : ''
                }`}
              >
                <svg
                  className="mr-3"
              ...
              <p
                onClick={() => setFilterItem('video')}
                className={`flex items-center font-montserrat py-3 px-5 transition-all hover:bg-gray-light2 cursor-pointer ${
                  currentFilter.video ? '!bg-gray-light2' : ''
                }`}
              >
                <svg
                  className="mr-3"
              ...
              <p
                onClick={() => setFilterItem('service')}
                className={`flex items-center font-montserrat py-3 px-5 transition-all hover:bg-gray-light2 cursor-pointer ${
                  currentFilter.service ? '!bg-gray-light2' : ''
                }`}
              >
                <svg
                  className="mr-3"
              ...
              <p
                onClick={() => setFilterItem('product')}
                className={`flex items-center font-montserrat py-3 px-5 transition-all hover:bg-gray-light2 cursor-pointer ${
                  currentFilter.product ? '!bg-gray-light2' : ''
                }`}
              >
                <svg
                  className="mr-3"
              ...
              <p
                onClick={() => setFilterItem('active')}
                className={`flex items-center font-montserrat py-3 px-5 transition-all hover:bg-gray-light2 cursor-pointer ${
                  currentFilter.active ? '!bg-gray-light2' : ''
                }`}
              >
                <svg
                  className="mr-3"
                ...
                <>
                  <div className="px-60px .1x1:px-10 border mr-10px mb-10px relative hoverI transition-all border-white hover:bg-white-BG_FILTER hover:border-gray-light2">
                    <div className="hidden items-center absolute left-14px top-14px hoverShowI">
                      ...
                      <label
                        htmlFor="checkSearchAll"
                        className="w-5 h-5 border-gray-deNum cursor-pointer border"
                      ></label>
                    </div>

                    <svg
                      className="absolute hidden hoverShowI left-3 top-11"
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                      fill="none"
                    ...
                    <div className="pb-3 ..5x1:w-56 ..5x1:h-56 relative">
                      <svg
                        className="absolute right-3 hidden top-3 hoverShowI z-10"
                        width="16"
                        height="16"
                        viewBox="0 0 16 16"
                        fill="none"
              ...
              {currentFilter.video && (
                <>
                  <div className="w-full flex pb-3">
                    <p className="font-montserrat font-medium  text-gray-quick-silver mr-4">
                      Сортировка:
                    </p>
                    <p className="mr-3 font-montserrat pb-0.5 font-medium text-primary border-b border-b-primary border-dotted">
                      По умолчанию
                    </p>
                    <p className="font-montserrat font-medium pb-0.5  border-b border-gray-quick-silver border-dotted text-black-70pe ">
                      Без подписей
                    </p>
                  </div>
                    ...
                    <div className="pb-3 relative ..5x1:w-56 ">
                      <div className="absolute z-10 left-0 right-0 bottom-0 top-0 flex items-center justify-center">
                        ...
                        >
                          ...
                          />
                          <path
                            d="M89.4999 45C89.4999 69.5767 69.5766 89.5 45 89.5C20.4233 89.5 0.5 69.5767 0.5 45C0.5 20.4233 20.4233 0.5 45 0.5C69.5766 0.5 89.4999 20.4233 89.4999 45Z"
                            stroke="white"
                            stroke-opacity="0.8"
                          />
                        </svg>
                  ...
                  <div className="p-4 h-379px w-278px bg-gray-light">
                    <div className="h-full p-4 bg-white flex items-center justify-center">
                      <div className="flex items-center flex-col">
                        <p className="font-montserrat text-22px font-medium leading-120% text-center">
                          Сертификат соответствия
                        </p>
                        <p className="font-montserrat font-medium text-gray-quick-silver leading-120% mt-3 mb-11 text-center">
                          Евразийский экономический союз
                        </p>
                        <button>
                          <svg
                          ...
                          >
                            ...
                            <path
                              d="M14 32H30.4706V29.6471H14M30.4706 19.0588H25.7647V12H18.7059V19.0588H14L22.2353 27.2941L30.4706 19.0588Z"
                              fill="black"
                            />
                            <defs>
                              <filter
                                id="filter0_b_3037_526760"
                                x="-4"
                                y="-4"
                                width="52"
                                height="52"
                              ...
                              >
                                ...
                                <feComposite
                                  in2="SourceAlpha"
                                  operator="in"
                                  result="effect1_backgroundBlur_3037_526760"
                                />
                                <feBlend
                                  mode="normal"
                                  in="SourceGraphic"
                                  in2="effect1_backgroundBlur_3037_526760"
                                  result="shape"
                                />
                              </filter>
                            </defs>
              ...
              {currentFilter.product && (
                <>
                  <div className="w-full flex pb-3">
                    ...
                    <p className="font-montserrat font-medium pb-0.5  border-b mr-3 border-gray-quick-silver border-dotted text-black-70pe ">
                      Буклеты
                    </p>
                    <p className="font-montserrat font-medium pb-0.5  border-b mr-3 border-gray-quick-silver border-dotted text-black-70pe ">
                      Ролл апы
                  ...
                  <div className="px-60px .1x1:px-10 border mr-10px mb-10px relative hoverI transition-all border-white hover:bg-white-BG_FILTER hover:border-gray-light2">
                    ...
                    <p className="text-center font-montserrat pb-4 font-medium text-13px text-gray-quick-silver">
                      PDF
                    </p>
                  </div>
                </>
                  ...
                  <div className=".5x1:w-1100px .4x2:w-910px w-1200 .2x1.0:w-800px .1x01:w-727px ..5x1:w-664px .1x1:ml-4 ..5x01:w-600px">
                    <div className="p-3   border border-stroke">
                      <div className="w-full flex ">
                        ...
                        <p className="font-montserrat font-medium text-xl text-gray-quick-silver ml-2">
                          3
                        </p>
                      </div>
                      <Slider
                        {...settings}
                        className="pt-13px ..6x6:pt-44 newsSlider ..7x001:px-3 "
                      >
                        <div className=" relative pr-5px  ..6x04:p-1.5 transition-all  newsCardHover  cursor-pointer hover:scale-95">
                          ...
                          <div className="  -mt-4 relative">
                            ...
                            <p className="text-center  mt-2 px-5 leading-140% ..6x3:px-4 mb-5 news_text font-montserrat ..6x4:text-11px">
                              Все помнят тот самый косметический спонж, который
                              под струей воды превращался из палочки в круглый
                              диск Все помнят тот самый косметический спонж,
                              который под струей воды превращался
                            </p>
                            <button className="relative ability left-1/2 bottom-5 font-semibold  text-13px font-montserrat text-black">
                              Читать
                              <div className="bg-primary lineHover absolute bottom-0.5 -left-1.5 opacity-40 h-9px w-14 ..6x4:ml-0  ml-0.5 ..5x2:ml-1" />
                      ...
                      <div className="flex ">
                        <div className="mt-3  .5x01:w-300px mr-10px relative">
                          ...
                          <div>
                            ...
                            <p className="font-montserrat font-medium text-sm text-gray-quick-silver mt-2 mb-4">
                              19 часов назад
                            </p>
                          </div>
                          <div className="absolute top-1.5 flex items-center left-2">
      ...
      <div>
        <h4 className="font-montserrat font-medium text-xl mb-3 ..6x3:mb-6px ..6x3:text-sm">
          Фото и видео отзывы
        </h4>
        <div className="mb-12 relative ..6x3:-mr-3 ..6x3:mb-6">
          <Swiper
            ref={sliderPhoto}
            className="firstSlider sliderPaginationCustom "
            breakpoints={{
              950: {
                slidesPerView: 5,
              },
          ...
          >
            ...
            <SwiperSlide className="pr-2 relative cursor-pointer">
              <div className="absolute flex items-center justify-center left-0 right-0 bottom-0 top-0 z-10">
                <svg
                  className="..5x4:h-38px ..5x4:w-38px"
                  width="90"
                  height="90"
                  viewBox="0 0 90 90"
                  fill="none"
          ...
          <button
            onMouseEnter={hoverSet}
            onMouseLeave={hoverSet}
            onClick={prevSlidePhoto}
            className="activeArrow absolute hover:bg-black transition-all   ..5x2:hidden h-8 w-8 bg-white  -left-8   top-20 flex justify-center  rounded-56px items-center  z-10"
          >
            <svg
              width="9"
              height="14"
            ...
            >
              <path
                ...
                fill={`${buttonHover ? 'white' : 'black'}`}
              />
            </svg>
          </button>
          <button
            onMouseEnter={hoverNext}
            onMouseLeave={hoverNext}
            onClick={nextSlidePhoto}
            className=" absolute  ..5x2:hidden right-36 hover:bg-black transition-all   h-8 w-8 top-20 bg-white z-10 flex justify-center items-center rounded-56px"
          >
            <svg
              width="9"
              height="14"
            ...
            >
              <path
                d="M8.53875 7L1.27625 14L0.375 13.125L3.875 7.875L4.4875 7L3.875 6.125L0.375 0.875L1.27625 0L8.53875 7Z"
                fill={`${buttonHoverNext ? 'white' : 'black'}`}
              />
            </svg>
          </button>
        </div>
        <div className="flex ..5x2:flex-col ..5x2:overflow-hidden">
          <div className="mr-60px .2x1.0:mr-2 ..5x2:mr-0">
            <div className="flex items-center mb-6 ..5x2:mb-3 ..6x3:flex-wrap">
              <p className="font-montserrat mr-4 ..7x59:mr-2 ..6x3:mr-20 ..5x01:text-sm font-medium text-xl">
                5 отзывов со средней оценкой 4,4
              </p>
              <div className="flex items-center ">
                <svg
                  className="..6x3:mt-1 ..5x2:h-3 ..5x2:w-3"
                  width="18"
                  height="18"
                  viewBox="0 0 18 18"
                  fill="none"
            ...
            <button
              onClick={setShowL}
              className="h-11 transition-all hover:bg-primary-hover ..6x3:mb-3 ..5x2:h-8 px-5 mb-6 font-montserrat text-xs text-white font-medium bg-primary flex items-center justify-center"
            >
              <svg
                className="mr-6px ..5x2:h-14px ..5x2:w-14px"
                width="20"
                height="20"
                viewBox="0 0 20 20"
                fill="none"
            ...
            <div>
              <div className="p-6 .2x1.0:p-3 ..6x3:mb-3 mb-18px bg-gray-100">
                  ...
                  <div className="flex pb-4 ..6x3:pb-3 ..6x3:m-0 border-disable w-full mt-4 ml-4 justify-between items-center border-b ">
                    <div className="flex items-center">
                      ...
                      <div className="flex items-center ..6x3:flex-col ..6x3:items-start">
                        <p className=" font-montserrat font-medium ..5x01:text-13px ..6x3:mb-0.5">
                          Марина Одинцова
                        </p>
                        <div className="w-4 border-b mx-2 ..6x3:hidden"></div>
                        <p className="font-montserrat text-black-70pe ..5x01:text-13px">
                          May 20, 2022
                        </p>
                      </div>
                    </div>
                ...
                <p className="pl-74px ..6x3:pl-0 mt-3 font-montserrat .1x01:text-13px text-black-70pe">
                  Мне показалось, что кожу стянуло после использования. Ощущение
                  после применения среднее
                </p>
              </div>
              <div className="p-6 .2x1.0:p-3 ..6x3:mb-3 mb-18px bg-gray-100">
                <div className="flex items-center ">
                ...
                <p className="pl-74px ..6x3:pl-0 mt-3 font-montserrat .1x01:text-13px text-black-70pe">
                  ...
                  плотной, упругой и очень приятной на ощупь. Единственное, что
                  мне не подошло - время нанесения. Два дня делала на ночь -
                  вставала сильно отекшей. Перенесла применение на 5-6 часов
                  вечера и все нормализовалось. Отеков нет. Зато есть реально
                  помолодевшая кожа. Микро морщинок словно и не бывало.
                </p>
              </div>
              <div className="p-6 .2x1.0:p-3 ..6x3:mb-3 mb-18px bg-gray-100">
                <div className="flex items-center ">
                ...
                <p className="pl-74px ..6x3:pl-0 mt-3 font-montserrat .1x01:text-13px text-black-70pe">
                  ...
                  Значительно улучшился цвет лица, кожа просто сияет красотой и
                  здоровьем, маска сняла следы стресса, придала мягкость,
                  бархатистость и упругость коже!!! Мгновенный эффект ухоженной
                  кожи! Спасибо компания TianDe 😘
                </p>
              </div>
            </div>
            <button className="w-full h-11 flex justify-center items-center border border-stroke mb-24 font-montserrat text-xs ..6x3:text-13px ..6x3:h-10 ..5x2:mb-6 ..6x3:hidden font-medium">
              Показать ещё 2 из 5
            </button>
            <button className="w-full h-11  justify-center items-center border border-stroke mb-24 font-montserrat text-xs ..6x3:text-13px ..6x3:h-10 ..6x3:flex hidden ..5x2:mb-6 ">
              Показать ещё{' '}
            </button>
          </div>
          <div className="..5x2:flex ..5x2:items-center ..5x2:flex-col">
            <p className="mb-4 font-montserrat text-xl ..6x3:mb-6px ..6x3:text-sm ..6x3:leading-140% font-medium leading-120%">
            ...
            <div className="commentPhoto relative">
              ...
              <button className=" bg-white-60pe absolute left-6 top-6 ..6x3:top-4 ..6x3:left-4 px-8 h-11 flex justify-center items-center font-montserrat text-xs font-medium ..6x3:text-xs ..6x3:h-8 ..6x3:px-5">
                Подробнее
              </button>
            </div>
          </div>
