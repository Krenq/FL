	...
	return (
		<div className="relative promo ">
			...
			<div className="absolute ..5x3:relative ..5x3:left-0 top-20 left-40 .4x1:top-7 .4x1:left-20 ..5x3:flex ..5x3:flex-col  ..5x3:items-center  text-white">
				<p className="text-6xl .2x1:text-5xl ..5x1:text-4xl ..7x2:text-3xl ..5x3:text-center">Скидка 20% по <br /> промокоду «Click»</p>
				<p className="mt-6 font-medium text-xl .2x1:text-lg ..7x2:text-sm ..5x1:text-base ..5x3:text-center .2x1:mt-4">На аквагель для лица серии «FreshClick»</p>
				<div>
					<button className="border-2 .2x1:py-3 ..7x2:px-12 .2x1:px-16 border-gray bg-gray mt-8 text-gray-quick-silver px-24 py-5 transition-all hover:border-primary hover:text-white hover:bg-primary">CLICK</button>
					<button className=" border-2 border-gray ..7x2:px-9 ..7x2:pr-5 px-10 .2x1:py-3 py-5 relative "> <svg className="absolute .2x1:top-4 top-6 left-4" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
