...
function Clubs({ refL }) {
	return (
		<section ref={refL} id='sec-13' className="relative bg-nude-2 mt-16 .1x1:mt-14">
			...
			<p className="text-26px font-montserrat font-medium pt-32 absolute -top-8 left-1/2 ability ..5x2:text-16px w-full text-center">
				Программа лояльности
			</p>
			<p className="ability w-full left-1/2 absolute text-32px italic top-32  font-montserrat font-medium ..5x2:top-28    text-center ..5x2:text-22px  ">
				ВСТУПАЙ В КЛУБ
			</p>
