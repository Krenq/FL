	...
	return (
		<section className={`fixed left-0 right-0 z-100 bottom-0 top-0 bg-white ${isFullView || isFullViewVideo ? '!bg-gray-light ..5x2:!bg-white' : ""} ${isShow ? 'block' : "hidden"}`}>
			<div className="h-full relative    ">
				...
				{(isFullView || isFullViewVideo) && <div className="flex absolute .4x2:right-40 ..5x2:top-4 ..5x2:left-4 top-60px z-10 right-272px items-center">
				...
				{isFullViewVideo && <div className="absolute ..5x2:hidden .4x2:right-28 top-100px w-300px right-230px z-10 bg-white p-5">
				...
				{isFullViewVideo && <div className="absolute ..5x2:hidden .4x2:right-28 top-272px w-300px right-230px z-10 bg-white p-5">
					<p className="mb-3 font-montserrat font-semibold text-sm">Поделиться файлом</p>
