					...
					<div className="flex .2x10:flex-col -mr-1 .2x10:items-center">
						...
						<div className="mt-6 w-full ..6x04:mt-5 ..5x1:w-800px ..5x5:w-full .2x10:w-910px">
							...
							<div className='flex px-3 ..6x04:pl-0 items-center mt-4 relative pb-4 border-b ..6x04:pb-10px  border-dashed border-gray'>
								<svg className='absolute  right-3 top-5 ..6x04:top-3' width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path d="M10.3396 5.075L7 8.4281L3.65312 5.075L2.625 6.10729L7 10.5L11.375 6.10729L10.3396 5.075Z" fill="black" fillOpacity="0.7" />
								</svg>
							...
							<div className='flex px-3 ..6x04:pl-0 items-center mt-6 relative pb-6 border-b ..6x04:pb-10px  border-dashed border-gray '>
								<svg className='absolute right-3 top-3 ..6x04:top-1' width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path d="M10.3396 5.075L7 8.4281L3.65312 5.075L2.625 6.10729L7 10.5L11.375 6.10729L10.3396 5.075Z" fill="black" fillOpacity="0.7" />
								</svg>
								...
								<div onClick={() => setShowLocal('activeComoonents')} className={`mt-1  h-12 buttonShadow p-3.5 rounded transition-all ${show.activeComponents ? 'activeButtonS' : 'overflow-hidden'}`}>
									<div className="flex items-center justify-between">
										<p className="font-montserrat mb-3 text-sm font-medium flex items-center "><svg className="mr-2" width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
											...
											<path fill-rule="evenodd" clip-rule="evenodd" d="M7.09157 0.71301C7.37559 0.428994 7.83607 0.428997 8.12009 0.713016L9.14255 1.73549L9.14855 1.74142L13.2626 5.85549C13.5466 6.13951 13.5466 6.59999 13.2626 6.88401L7.60579 12.5409C7.4694 12.6773 7.28441 12.7539 7.09153 12.7539C6.89864 12.7539 6.71366 12.6773 6.57727 12.5409L2.46319 8.42681C2.17917 8.14279 2.17917 7.68231 2.46319 7.39829L7.60574 2.25572L7.09156 1.74153C6.80755 1.45751 6.80755 0.997026 7.09157 0.71301ZM4.00597 7.91255L4.56828 7.35024L9.21247 8.87714L7.09152 10.9981L4.00597 7.91255ZM10.3648 7.72485L5.72057 6.19794L8.63429 3.2842L11.7198 6.36975L10.3648 7.72485Z" stroke="#337202" stroke-width="0.6" stroke-linecap="round" />
											<path d="M13.4773 12.6804C14.2806 12.6804 14.9318 12.0292 14.9318 11.2259C14.9318 10.6903 14.447 9.96302 13.4773 9.04403C12.5076 9.96302 12.0227 10.6903 12.0227 11.2259C12.0227 12.0292 12.674 12.6804 13.4773 12.6804Z" stroke="#337202" stroke-width="0.6" stroke-linecap="round" />
											<path d="M1.47727 14.1349C1.07561 14.1349 0.75 14.4606 0.75 14.8622C0.75 15.2639 1.07561 15.5895 1.47727 15.5895H16.0227C16.4244 15.5895 16.75 15.2639 16.75 14.8622C16.75 14.4606 16.4244 14.1349 16.0227 14.1349H1.47727Z" stroke="#337202" stroke-width="0.6" stroke-linecap="round" />
										</svg>
